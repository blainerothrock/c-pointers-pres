...
C is strictly pass by value — arguments are **copied**.

Why doesn't swap work? 

Let's walk through memory step by step.

<!--
Re-run the code to remind students of the surprising result before diving into the memory walkthrough.
-->
